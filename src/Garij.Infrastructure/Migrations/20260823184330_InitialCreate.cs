        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Part_QuantityInStock", "\"QuantityInStock\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicensePlateNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtUsage = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobPartsUsed", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobPartsUsed_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPartsUsed_ServiceJobs_ServiceJobId",
                        column: x => x.ServiceJobId,
                        principalTable: "ServiceJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobServiceDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobServiceDetails_ServiceCatalogs_ServiceCatalogId",
                        column: x => x.ServiceCatalogId,
                        principalTable: "ServiceCatalogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobServiceDetails_ServiceJobs_ServiceJobId",
                        column: x => x.ServiceJobId,
                        principalTable: "ServiceJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleInJob = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MechanicAssignments_ApplicationUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MechanicAssignments_ServiceJobs_ServiceJobId",
                        column: x => x.ServiceJobId,
                        principalTable: "ServiceJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MechanicAssignments_StaffUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_ServiceJobs_ServiceJobId",
                        column: x => x.ServiceJobId,
                        principalTable: "ServiceJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPartsUsed_PartId",
                table: "JobPartsUsed",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPartsUsed_ServiceJobId",
                table: "JobPartsUsed",
                column: "ServiceJobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobServiceDetails_ServiceCatalogId",
                table: "JobServiceDetails",
                column: "ServiceCatalogId");

            migrationBuilder.CreateIndex(
                name: "IX_JobServiceDetails_ServiceJobId",
                table: "JobServiceDetails",
                column: "ServiceJobId");

            migrationBuilder.CreateIndex(
                name: "IX_MechanicAssignments_ApplicationUserId",
                table: "MechanicAssignments",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MechanicAssignments_ServiceJobId",
                table: "MechanicAssignments",
                column: "ServiceJobId");

            migrationBuilder.CreateIndex(
                name: "IX_MechanicAssignments_UserId",
                table: "MechanicAssignments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ServiceJobId",
                table: "Notifications",
                column: "ServiceJobId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceJobs_BookingReference",
                table: "ServiceJobs",
